...
WHERE LOWER(c.owner) = LOWER('pcuser') AND
      LOWER(t.table_name) IN ('pc_bopbuildingcov', 'pc_boplocationcov', 'pc_businessownerscov', 'pc_etlclausepattern', 'pc_job', 'pc_personalautocov', 'pc_personalvehiclecov', 'pc_policy', 'pc_policyline', 'pc_policyperiod', 'pc_uwcompany', 'pctl_currency', 'pctl_job', 'pctl_policyline', 'pctl_policyperiodstatus')
...
relationsInputs =
  ...
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM5AVL" "CHAR" (Just 4) Nothing Nothing Nullable 1)
  , Input "PC_BOPBUILDINGCOV" (Column "FIXEDID" "NUMBER" (Just 22) Nothing Nothing NotNullable 2)
  , Input "PC_BOPBUILDINGCOV" (Column "CURRENCY" "NUMBER" (Just 22) Nothing Nothing NotNullable 3)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 4)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM5AVL" "CHAR" (Just 4) Nothing Nothing Nullable 5)
  , Input "PC_BOPBUILDINGCOV" (Column "UPDATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 6)
  , Input "PC_BOPBUILDINGCOV" (Column "DIRECTTERM3AVL" "CHAR" (Just 4) Nothing Nothing Nullable 7)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 8)
  , Input "PC_BOPBUILDINGCOV" (Column "ID" "NUMBER" (Just 22) Nothing Nothing NotNullable 9)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM1" "CHAR" (Just 4) Nothing Nothing Nullable 10)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM2" "CHAR" (Just 4) Nothing Nothing Nullable 11)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM3" "CHAR" (Just 4) Nothing Nothing Nullable 12)
  , Input "PC_BOPBUILDINGCOV" (Column "DATETERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 13)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM4" "CHAR" (Just 4) Nothing Nothing Nullable 14)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM5" "CHAR" (Just 4) Nothing Nothing Nullable 15)
  , Input "PC_BOPBUILDINGCOV" (Column "CREATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 16)
  , Input "PC_BOPBUILDINGCOV" (Column "BEANVERSION" "NUMBER" (Just 22) Nothing Nothing Nullable 17)
  , Input "PC_BOPBUILDINGCOV" (Column "UPDATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 18)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM4AVL" "CHAR" (Just 4) Nothing Nothing Nullable 19)
  , Input "PC_BOPBUILDINGCOV" (Column "REFERENCEDATEINTERNAL" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 20)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM4AVL" "CHAR" (Just 4) Nothing Nothing Nullable 21)
  , Input "PC_BOPBUILDINGCOV" (Column "DIRECTTERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 22)
  , Input "PC_BOPBUILDINGCOV" (Column "BRANCHID" "NUMBER" (Just 22) Nothing Nothing NotNullable 23)
  , Input "PC_BOPBUILDINGCOV" (Column "PUBLICID" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 24)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM1" "VARCHAR2" (Just 256) Nothing Nothing Nullable 25)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM2" "VARCHAR2" (Just 256) Nothing Nothing Nullable 26)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM3" "VARCHAR2" (Just 256) Nothing Nothing Nullable 27)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM4" "VARCHAR2" (Just 256) Nothing Nothing Nullable 28)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM5" "VARCHAR2" (Just 256) Nothing Nothing Nullable 29)
  , Input "PC_BOPBUILDINGCOV" (Column "CREATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 30)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM3AVL" "CHAR" (Just 4) Nothing Nothing Nullable 31)
  , Input "PC_BOPBUILDINGCOV" (Column "EFFECTIVEDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 32)
  , Input "PC_BOPBUILDINGCOV" (Column "DATETERM1" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 33)
  , Input "PC_BOPBUILDINGCOV" (Column "DATETERM2" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 34)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM3AVL" "CHAR" (Just 4) Nothing Nothing Nullable 35)
  , Input "PC_BOPBUILDINGCOV" (Column "DIRECTTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 36)
  , Input "PC_BOPBUILDINGCOV" (Column "FROZENSETID" "NUMBER" (Just 22) Nothing Nothing Nullable 37)
  , Input "PC_BOPBUILDINGCOV" (Column "EXPIRATIONDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 38)
  , Input "PC_BOPBUILDINGCOV" (Column "ARCHIVEPARTITION" "NUMBER" (Just 22) Nothing Nothing Nullable 39)
  , Input "PC_BOPBUILDINGCOV" (Column "CHANGETYPE" "NUMBER" (Just 22) Nothing Nothing Nullable 40)
  , Input "PC_BOPBUILDINGCOV" (Column "BASEDONID" "NUMBER" (Just 22) Nothing Nothing Nullable 41)
  , Input "PC_BOPBUILDINGCOV" (Column "SCHEDULEAUTONUMBERSEQ" "NUMBER" (Just 22) Nothing Nothing Nullable 42)
  , Input "PC_BOPBUILDINGCOV" (Column "CHOICETERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 43)
  , Input "PC_BOPBUILDINGCOV" (Column "BOPBUILDING" "NUMBER" (Just 22) Nothing Nothing Nullable 44)
  , Input "PC_BOPBUILDINGCOV" (Column "BOOLEANTERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 45)
  , Input "PC_BOPBUILDINGCOV" (Column "SUBTYPE" "NUMBER" (Just 22) Nothing Nothing NotNullable 46)
  , Input "PC_BOPBUILDINGCOV" (Column "DIRECTTERM1" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 47)
  , Input "PC_BOPBUILDINGCOV" (Column "DIRECTTERM2" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 48)
  , Input "PC_BOPBUILDINGCOV" (Column "PATTERNCODE" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 49)
  , Input "PC_BOPBUILDINGCOV" (Column "DIRECTTERM3" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 50)
  , Input "PC_BOPBUILDINGCOV" (Column "DATETERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 51)
  , Input "PC_BOPLOCATIONCOV" (Column "STRINGTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 1)
  , Input "PC_BOPLOCATIONCOV" (Column "PUBLICID" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 2)
  , Input "PC_BOPLOCATIONCOV" (Column "CHOICETERM1" "VARCHAR2" (Just 256) Nothing Nothing Nullable 3)
  , Input "PC_BOPLOCATIONCOV" (Column "CHOICETERM2" "VARCHAR2" (Just 256) Nothing Nothing Nullable 4)
  , Input "PC_BOPLOCATIONCOV" (Column "CREATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 5)
  , Input "PC_BOPLOCATIONCOV" (Column "FIXEDID" "NUMBER" (Just 22) Nothing Nothing NotNullable 6)
  , Input "PC_BOPLOCATIONCOV" (Column "CURRENCY" "NUMBER" (Just 22) Nothing Nothing NotNullable 7)
  , Input "PC_BOPLOCATIONCOV" (Column "CHOICETERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 8)
  , Input "PC_BOPLOCATIONCOV" (Column "STRINGTERM1" "VARCHAR2" (Just 1020) Nothing Nothing Nullable 9)
  , Input "PC_BOPLOCATIONCOV" (Column "EFFECTIVEDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 10)
  , Input "PC_BOPLOCATIONCOV" (Column "UPDATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 11)
  , Input "PC_BOPLOCATIONCOV" (Column "BOOLEANTERM3AVL" "CHAR" (Just 4) Nothing Nothing Nullable 12)
  , Input "PC_BOPLOCATIONCOV" (Column "BOOLEANTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 13)
  , Input "PC_BOPLOCATIONCOV" (Column "ID" "NUMBER" (Just 22) Nothing Nothing NotNullable 14)
  , Input "PC_BOPLOCATIONCOV" (Column "DIRECTTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 15)
  , Input "PC_BOPLOCATIONCOV" (Column "FROZENSETID" "NUMBER" (Just 22) Nothing Nothing Nullable 16)
  , Input "PC_BOPLOCATIONCOV" (Column "EXPIRATIONDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 17)
  , Input "PC_BOPLOCATIONCOV" (Column "BOOLEANTERM1" "CHAR" (Just 4) Nothing Nothing Nullable 18)
  , Input "PC_BOPLOCATIONCOV" (Column "BOOLEANTERM2" "CHAR" (Just 4) Nothing Nothing Nullable 19)
  , Input "PC_BOPLOCATIONCOV" (Column "BOOLEANTERM3" "CHAR" (Just 4) Nothing Nothing Nullable 20)
  , Input "PC_BOPLOCATIONCOV" (Column "CREATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 21)
  , Input "PC_BOPLOCATIONCOV" (Column "ARCHIVEPARTITION" "NUMBER" (Just 22) Nothing Nothing Nullable 22)
  , Input "PC_BOPLOCATIONCOV" (Column "BEANVERSION" "NUMBER" (Just 22) Nothing Nothing Nullable 23)
  , Input "PC_BOPLOCATIONCOV" (Column "CHANGETYPE" "NUMBER" (Just 22) Nothing Nothing Nullable 24)
  , Input "PC_BOPLOCATIONCOV" (Column "BASEDONID" "NUMBER" (Just 22) Nothing Nothing Nullable 25)
  , Input "PC_BOPLOCATIONCOV" (Column "UPDATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 26)
  , Input "PC_BOPLOCATIONCOV" (Column "CHOICETERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 27)
  , Input "PC_BOPLOCATIONCOV" (Column "REFERENCEDATEINTERNAL" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 28)
  , Input "PC_BOPLOCATIONCOV" (Column "BOPLOCATION" "NUMBER" (Just 22) Nothing Nothing Nullable 29)
  , Input "PC_BOPLOCATIONCOV" (Column "BOOLEANTERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 30)
  , Input "PC_BOPLOCATIONCOV" (Column "DIRECTTERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 31)
  , Input "PC_BOPLOCATIONCOV" (Column "SUBTYPE" "NUMBER" (Just 22) Nothing Nothing NotNullable 32)
  , Input "PC_BOPLOCATIONCOV" (Column "DIRECTTERM1" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 33)
  , Input "PC_BOPLOCATIONCOV" (Column "DIRECTTERM2" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 34)
  , Input "PC_BOPLOCATIONCOV" (Column "BRANCHID" "NUMBER" (Just 22) Nothing Nothing NotNullable 35)
  , Input "PC_BOPLOCATIONCOV" (Column "PATTERNCODE" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 36)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM5" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 1)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM6" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 2)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM7" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 3)
  , Input "PC_BUSINESSOWNERSCOV" (Column "STRINGTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 4)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM8" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 5)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM9" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 6)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM17AVL" "CHAR" (Just 4) Nothing Nothing Nullable 7)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM13AVL" "CHAR" (Just 4) Nothing Nothing Nullable 8)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM9AVL" "CHAR" (Just 4) Nothing Nothing Nullable 9)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM20" "VARCHAR2" (Just 256) Nothing Nothing Nullable 10)
  , Input "PC_BUSINESSOWNERSCOV" (Column "FIXEDID" "NUMBER" (Just 22) Nothing Nothing NotNullable 11)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM5AVL" "CHAR" (Just 4) Nothing Nothing Nullable 12)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CURRENCY" "NUMBER" (Just 22) Nothing Nothing NotNullable 13)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 14)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM7AVL" "CHAR" (Just 4) Nothing Nothing Nullable 15)
  , Input "PC_BUSINESSOWNERSCOV" (Column "UPDATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 16)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM3AVL" "CHAR" (Just 4) Nothing Nothing Nullable 17)
  , Input "PC_BUSINESSOWNERSCOV" (Column "ID" "NUMBER" (Just 22) Nothing Nothing NotNullable 18)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DATETERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 19)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CREATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 20)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM16AVL" "CHAR" (Just 4) Nothing Nothing Nullable 21)
  , Input "PC_BUSINESSOWNERSCOV" (Column "BEANVERSION" "NUMBER" (Just 22) Nothing Nothing Nullable 22)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM12AVL" "CHAR" (Just 4) Nothing Nothing Nullable 23)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM8AVL" "CHAR" (Just 4) Nothing Nothing Nullable 24)
  , Input "PC_BUSINESSOWNERSCOV" (Column "UPDATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 25)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM4AVL" "CHAR" (Just 4) Nothing Nothing Nullable 26)
  , Input "PC_BUSINESSOWNERSCOV" (Column "REFERENCEDATEINTERNAL" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 27)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM6AVL" "CHAR" (Just 4) Nothing Nothing Nullable 28)
  , Input "PC_BUSINESSOWNERSCOV" (Column "BOPLINE" "NUMBER" (Just 22) Nothing Nothing Nullable 29)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 30)
  , Input "PC_BUSINESSOWNERSCOV" (Column "BRANCHID" "NUMBER" (Just 22) Nothing Nothing NotNullable 31)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM19AVL" "CHAR" (Just 4) Nothing Nothing Nullable 32)
  , Input "PC_BUSINESSOWNERSCOV" (Column "PUBLICID" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 33)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM1" "VARCHAR2" (Just 256) Nothing Nothing Nullable 34)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM2" "VARCHAR2" (Just 256) Nothing Nothing Nullable 35)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM3" "VARCHAR2" (Just 256) Nothing Nothing Nullable 36)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM15AVL" "CHAR" (Just 4) Nothing Nothing Nullable 37)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM4" "VARCHAR2" (Just 256) Nothing Nothing Nullable 38)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM5" "VARCHAR2" (Just 256) Nothing Nothing Nullable 39)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CREATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 40)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM6" "VARCHAR2" (Just 256) Nothing Nothing Nullable 41)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM11AVL" "CHAR" (Just 4) Nothing Nothing Nullable 42)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM7" "VARCHAR2" (Just 256) Nothing Nothing Nullable 43)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM8" "VARCHAR2" (Just 256) Nothing Nothing Nullable 44)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM9" "VARCHAR2" (Just 256) Nothing Nothing Nullable 45)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM7AVL" "CHAR" (Just 4) Nothing Nothing Nullable 46)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM3AVL" "CHAR" (Just 4) Nothing Nothing Nullable 47)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM9AVL" "CHAR" (Just 4) Nothing Nothing Nullable 48)
  , Input "PC_BUSINESSOWNERSCOV" (Column "STRINGTERM1" "VARCHAR2" (Just 1020) Nothing Nothing Nullable 49)
  , Input "PC_BUSINESSOWNERSCOV" (Column "EFFECTIVEDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 50)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM5AVL" "CHAR" (Just 4) Nothing Nothing Nullable 51)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DATETERM1" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 52)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 53)
  , Input "PC_BUSINESSOWNERSCOV" (Column "FROZENSETID" "NUMBER" (Just 22) Nothing Nothing Nullable 54)
  , Input "PC_BUSINESSOWNERSCOV" (Column "EXPIRATIONDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 55)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM18AVL" "CHAR" (Just 4) Nothing Nothing Nullable 56)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM14AVL" "CHAR" (Just 4) Nothing Nothing Nullable 57)
  , Input "PC_BUSINESSOWNERSCOV" (Column "ARCHIVEPARTITION" "NUMBER" (Just 22) Nothing Nothing Nullable 58)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHANGETYPE" "NUMBER" (Just 22) Nothing Nothing Nullable 59)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM10AVL" "CHAR" (Just 4) Nothing Nothing Nullable 60)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM10" "VARCHAR2" (Just 256) Nothing Nothing Nullable 61)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM20AVL" "CHAR" (Just 4) Nothing Nothing Nullable 62)
  , Input "PC_BUSINESSOWNERSCOV" (Column "BASEDONID" "NUMBER" (Just 22) Nothing Nothing Nullable 63)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM11" "VARCHAR2" (Just 256) Nothing Nothing Nullable 64)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM12" "VARCHAR2" (Just 256) Nothing Nothing Nullable 65)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM6AVL" "CHAR" (Just 4) Nothing Nothing Nullable 66)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM13" "VARCHAR2" (Just 256) Nothing Nothing Nullable 67)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM14" "VARCHAR2" (Just 256) Nothing Nothing Nullable 68)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM15" "VARCHAR2" (Just 256) Nothing Nothing Nullable 69)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 70)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM16" "VARCHAR2" (Just 256) Nothing Nothing Nullable 71)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM17" "VARCHAR2" (Just 256) Nothing Nothing Nullable 72)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM8AVL" "CHAR" (Just 4) Nothing Nothing Nullable 73)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM18" "VARCHAR2" (Just 256) Nothing Nothing Nullable 74)
  , Input "PC_BUSINESSOWNERSCOV" (Column "CHOICETERM19" "VARCHAR2" (Just 256) Nothing Nothing Nullable 75)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM4AVL" "CHAR" (Just 4) Nothing Nothing Nullable 76)
  , Input "PC_BUSINESSOWNERSCOV" (Column "SUBTYPE" "NUMBER" (Just 22) Nothing Nothing NotNullable 77)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM1" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 78)
  , Input "PC_BUSINESSOWNERSCOV" (Column "PATTERNCODE" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 79)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM2" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 80)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM3" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 81)
  , Input "PC_BUSINESSOWNERSCOV" (Column "DIRECTTERM4" "NUMBER" (Just 22) (Just 20) (Just 4) Nullable 82)
  ...
  , Input "PC_PERSONALVEHICLECOV" (Column "CHOICETERM1" "VARCHAR2" (Just 256) Nothing Nothing Nullable 1)
  , Input "PC_PERSONALVEHICLECOV" (Column "PUBLICID" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 2)
  , Input "PC_PERSONALVEHICLECOV" (Column "CHOICETERM2" "VARCHAR2" (Just 256) Nothing Nothing Nullable 3)
  , Input "PC_PERSONALVEHICLECOV" (Column "CREATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 4)
  , Input "PC_PERSONALVEHICLECOV" (Column "FIXEDID" "NUMBER" (Just 22) Nothing Nothing NotNullable 5)
  , Input "PC_PERSONALVEHICLECOV" (Column "CURRENCY" "NUMBER" (Just 22) Nothing Nothing NotNullable 6)
  , Input "PC_PERSONALVEHICLECOV" (Column "CHOICETERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 7)
  , Input "PC_PERSONALVEHICLECOV" (Column "EFFECTIVEDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 8)
  , Input "PC_PERSONALVEHICLECOV" (Column "UPDATETIME" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) NotNullable 9)
  , Input "PC_PERSONALVEHICLECOV" (Column "BOOLEANTERM1AVL" "CHAR" (Just 4) Nothing Nothing Nullable 10)
  , Input "PC_PERSONALVEHICLECOV" (Column "ID" "NUMBER" (Just 22) Nothing Nothing NotNullable 11)
  , Input "PC_PERSONALVEHICLECOV" (Column "FROZENSETID" "NUMBER" (Just 22) Nothing Nothing Nullable 12)
  , Input "PC_PERSONALVEHICLECOV" (Column "BOOLEANTERM1" "CHAR" (Just 4) Nothing Nothing Nullable 13)
  , Input "PC_PERSONALVEHICLECOV" (Column "EXPIRATIONDATE" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 14)
  , Input "PC_PERSONALVEHICLECOV" (Column "CREATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 15)
  , Input "PC_PERSONALVEHICLECOV" (Column "ARCHIVEPARTITION" "NUMBER" (Just 22) Nothing Nothing Nullable 16)
  , Input "PC_PERSONALVEHICLECOV" (Column "BEANVERSION" "NUMBER" (Just 22) Nothing Nothing Nullable 17)
  , Input "PC_PERSONALVEHICLECOV" (Column "CHANGETYPE" "NUMBER" (Just 22) Nothing Nothing Nullable 18)
  , Input "PC_PERSONALVEHICLECOV" (Column "PERSONALVEHICLE" "NUMBER" (Just 22) Nothing Nothing NotNullable 19)
  , Input "PC_PERSONALVEHICLECOV" (Column "BASEDONID" "NUMBER" (Just 22) Nothing Nothing Nullable 20)
  , Input "PC_PERSONALVEHICLECOV" (Column "UPDATEUSERID" "NUMBER" (Just 22) Nothing Nothing Nullable 21)
  , Input "PC_PERSONALVEHICLECOV" (Column "CHOICETERM2AVL" "CHAR" (Just 4) Nothing Nothing Nullable 22)
  , Input "PC_PERSONALVEHICLECOV" (Column "REFERENCEDATEINTERNAL" "TIMESTAMP(6)" (Just 11) Nothing (Just 6) Nullable 23)
  , Input "PC_PERSONALVEHICLECOV" (Column "SUBTYPE" "NUMBER" (Just 22) Nothing Nothing NotNullable 24)
  , Input "PC_PERSONALVEHICLECOV" (Column "PATTERNCODE" "VARCHAR2" (Just 256) Nothing Nothing NotNullable 25)
  , Input "PC_PERSONALVEHICLECOV" (Column "BRANCHID" "NUMBER" (Just 22) Nothing Nothing NotNullable 26)
